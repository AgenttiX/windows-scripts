...
$ChocoPrograms = [ordered]@{
    ...
    "Anaconda 3 (NOTE!)" = "anaconda3", "NOTE! Comes with lots of libraries. Use Miniconda or regular Python instead, unless you absolutely need this.";
    ...
    "Miniconda 3" = "miniconda3", "Anaconda package manager and Python 3 without the pre-installed libraries. Recommended over Anaconda and regular Python.";
    ...
    "Python (NOTE!)" = "python", "NOTE! This will be updated automatically in the future, which may break installed libraries. You should consider Miniconda instead."
