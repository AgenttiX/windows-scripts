...
$ChocoPrograms = [ordered]@{
    ...
    "Claude Code" = "claude-code", "AI client for coding";
    "Claude Desktop" = "claude", "AI client";
    "CLion" = "clion-ide", "C/C++ IDE, commercial use requires a license";
    "CMake" = "cmake", "C/C++ make utility";
    "Cygwin" = "cygwin", "Linux-like environment for Windows. Useful for C/C++ compilation.";
    ...
    # "OpenSC" = "opensc", "Smart card tools and PKCS#11 module";
    ...
    "Rust (GNU ABI)" = "rust", "Rust compiler toolchain";
    "Rust (MSVC ABI)" = "rust-ms", "Rust compiler toolchain, commercial use requires a Visual Studio license";
    ...
    "Visual Studio 2026 Build Tools" = "visualstudio2026buildtools", "C/C++ build tools. Commercial use requires a Visual Studio license. If you don't need MSVC ABI compatibility (for e.g. Python extension development), I recommend using Cygwin instead.";
