...
$ChocoPrograms = [ordered]@{
    ...
    "Visual Studio 2026 Build Tools" = "visualstudio2026buildtools", "C/C++ build tools. If you don't need MSVC ABI compatibility (for e.g. Python extension development), I recommend using Cygwin instead.";
